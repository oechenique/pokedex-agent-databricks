...
badges, resto->texto). Mira los tool_result reales de ESTE turno -- nunca
un tool_result bloqueado por un hook ni uno con isError, y nunca inventa un
formato si no hay datos de verdad detrás.

No toca agent/*.py: opera sobre la lista ya serializada (dicts planos, ver
serialize.py) que devuelve agent.send(), después de que corrió.
"""
